...
const ClinicalCalculator: React.FC<ClinicalCalculatorProps> = ({ children }) => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row sm:mx-2 sm:gap-2">
                ...
                {/* Calculator Tools */}
                <div
                    className={`w-full max-h-[calc(100vh-100px)] overflow-y-auto md:flex-1 ${isSideBarSelect ? "block" : "hidden"
                        } md:block`}
                >
                    <button
