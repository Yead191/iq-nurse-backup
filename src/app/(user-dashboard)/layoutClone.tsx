    ...
    return (
        <div>
            ...
            <div className='w-full flex h-[calc(100vh-80px)]'>
                ...
                <div className={`bg-[#FBFBFB] hidden lg:block w-[100px]}`}>
                ...
                <div className={`flex-1 lg:w-[calc(100%-100px)]`}>
                    <div className={`${pathname === "/new-chat" ? "bg-[#f6f6f6]" : "bg-[#FBFBFB]"} lg:px-4 px-0 pt-4 pb-0 h-[calc(100vh)] border-s-8 border-t-8 border-[#F4F4F4] rounded-md shadow-md`}>
                        <ConfigProvider
                            theme={{
                                token: {
                                    colorPrimary: '#0ea5e9',
