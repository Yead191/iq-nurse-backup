...
export default function LoginForm({ onFinish, form }: LoginFormProps) {
  ...
  return (
    <div
      className="justify-center items-center p-4 lg:p-8 border border-[#C5D0D0] rounded-xl w-full max-w-[500px]"
      style={{
        width: "100%",
        backgroundImage:
    ...
    >
      <div className="border border-[#C5D0D0] rounded-xl p-4 ">
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <Text style={{ color: "#6b7280", fontSize: lg ? "16px" : "14px" }}>
            Log in to access your personalized study plans and pick up right
            where you left off.
          </Text>
        </div>
