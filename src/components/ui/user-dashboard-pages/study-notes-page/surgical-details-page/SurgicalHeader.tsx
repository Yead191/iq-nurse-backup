...
function ActionButton({
  ...
  return (
    <div className="flex flex-col items-center group gap-2 cursor-pointer">
      <button className="flex flex-col items-center justify-center w-12 h-[40px] rounded-lg hover:bg-white transition-colors cursor-pointer group border border-[#003877] bg-[#F6F7F8]">
