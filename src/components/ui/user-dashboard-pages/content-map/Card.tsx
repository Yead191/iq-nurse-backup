  ...
  return (
    <div className="w-full">
      <div className="w-full  bg-white rounded-lg  border border-gray-50 shadow-lg p-6  mx-auto text-center">
        {/* Icon Circle */}
        <div className="w-16 h-16 mx-auto mb-6 rounded-full border border-[#2C5F8D] flex items-center justify-center">
          ...
          <button
            ...
            className={` ${
              items?.id === 1
                ...
                : " border border-[#2C5F8D] text-[#2C5F8D]"
            }  rounded-lg px-8 py-2 h-auto font-medium cursor-pointer `}
          >
            {items?.buttonText}
          </button>
        </Link>
