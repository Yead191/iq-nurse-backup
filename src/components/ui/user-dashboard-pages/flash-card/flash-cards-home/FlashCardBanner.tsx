...
const flashCards = [
  {
    ...
    title: "NCLEX-Focused",
    description:
      "Content aligned with the latest NCLEX test plan to ensure you're studying what matters most.",
  ...
  return (
    <div className=" md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {flashCards.map(
          ({ logo, title, description, id, buttonText, btnColor, path }) => {
            ...
            return (
              <div
                ...
                style={{
                  boxShadow: "3.83px 3.83px 47.91px 0px rgba(0, 0, 0, 0.11)",
                }}
