...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      />
      <div className="">
        <SupportBanner title="Legal Document" subTitle="Privacy Policy" />
      </div>

      {/* container   */}
      <div>
        <div className=" mx-auto my-8 p-6 border border-[#C5D0D0] rounded-lg  bg-white ">
          <h1 className="lg:text-xl text-lg font-medium mb-4">
            Effective Date: December 19, 2024
          </h1>
          <p className="text-lg lg:text-xl mb-6">
            Studyfy ("we," "us," or "our") respects the privacy of our users
            ("you" or "your"). This Privacy Policy describes the types of
            information we collect from and about you when you use our mobile
            application, Studyfy (the "App"), and how we use that information.
          </p>

          <h2 className="lg:text-xl text-lg font-medium mb-3">
          ...
          <ul className="list-inside list-disc lg:text-lg text-[16px] mb-4">
            ...
            <li>
              Usage Data: We collect information about how you use the App, such
              as the subjects you study, the resources you access, and the
              features you use.
            </li>
            <li>
          ...
          <ul className="list-inside list-disc lg:text-lg text-[16px] mb-4">
            <li>
              Provide and Improve the App: We use your information to provide
              and improve the App, including personalizing your study
              experience.
            </li>
            <li>
              Communicate with You: We may use your information to communicate
              with you about the App, such as sending you updates, promotional
              offers, and customer support.
            </li>
            <li>
              Analytics: We may use your information for analytics purposes to
              understand how users interact with the App and improve our
              services.
            </li>
          </ul>
          ...
          <p className="lg:text-lg text-[16px] mb-4">
