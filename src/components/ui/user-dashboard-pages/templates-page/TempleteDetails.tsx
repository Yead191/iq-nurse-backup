...
export default function TempleteDetails({ categories, setIsSideBarSelect }: IProps) {
    const { getTemplateData } = templateData
    const templete = getTemplateData.categories.find(({ id }) => id === categories.categoryId)?.templates.find(template => template.id === categories.templeteId) as any;
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="flex flex-col justify-between lg:flex-row gap-6">
                <div className="w-full lg:w-2/5">
                    <div className="bg-white rounded-md shadow-sm">
                        <div className="border border-gray-100 p-4 rounded-md">
                            <h2 className="text-lg font-semibold text-gray-500 mb-4 pb-1">Description</h2>
                ...
                {
                    slides?.length && <div className="w-full lg:w-2/4 relative">
