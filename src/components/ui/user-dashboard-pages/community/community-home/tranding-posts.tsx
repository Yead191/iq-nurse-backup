  ...
  const posts: Post[] = [
    {
      ...
      isLiked: true,
      avatar:
        "https://i.pinimg.com/originals/1d/f9/d4/1df9d49191b554fd08b35bc0164dae98.jpg",
    },
    {
      id: 2,
      author: "Sarah Johnson",
      ...
      isLiked: true,
      avatar:
        "https://image.shutterstock.com/shutterstock/photos/2180178057/display_1500/stock-photo-studio-portrait-photo-of-young-beautiful-asian-woman-in-formal-suit-dressing-with-confident-and-2180178057.jpg",
    },
  ];
        ...
        {posts.map((post) => (
          ...
          >
            ...
            <div className="flex items-center mb-3 !gap-2.5">
              <Avatar size={40} src={post.avatar} className="mr-3" />
