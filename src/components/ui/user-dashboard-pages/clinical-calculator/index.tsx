...
import CalculatorCategoryList from "./CalculatorCategoryList";
import CalculatorMainPanel from "./calculators";
    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row sm:mx-2 sm:gap-2">
                ...
                {/* Calculator Tools */}
                <div
                    className={`w-full max-h-[calc(100vh-80px)] overflow-y-auto md:flex-1 ${isSideBarSelect ? "block" : "hidden"
                        } md:block`}
                >
                    <button
