...
import { ReminderType, ScheduledClass, StudyMaterial } from "../ClassCalendar";
...
interface AddClassDialogProps {
  ...
  onAddClass: (newClass: ScheduledClass) => void;
  selectedDate: Date;
}
  ...
  return (
    ...
    >
      <div className="space-y-6">
        <Tabs defaultActiveKey="class-info" type="card">
          <TabPane tab="Class Information" key="class-info">
            <div className="space-y-5 px-1">
              <div>
                <div className="mb-1 font-medium">Class Title *</div>
                <Input
                  value={title}
              ...
              {reminder === "custom" && (
                <div>
                  <div className="mb-1 font-medium">Days Before Class</div>
                  <Input
                    type="number"
                    min={1}
                    max={30}
          ...
          <TabPane tab="Study Materials" key="materials">
              ...
              >
                <div className="space-y-4">
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-sm text-blue-900">
                    ...
                    existing library to attach to this class.
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <TextArea
                      ...
                      placeholder="Add notes or details about this material"
                      rows={3}
                    />
                  </div>
