    ...
    <div className="w-full max-w-sm bg-white  flex flex-col  h-[calc(100vh-95px)] md:h-[calc(100vh)] ">
      ...
      <div className=" p-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <span
            className={`text-sm  border    bg-transparent px-3 py-1 rounded capitalize`}
          >
            Members
          </span>
        </div>
        <div className="flex flex-col">
          <span
            className="text-[#1A2B49] text-[15px] font-semibold leading-tight py-2"
      ...
      <div className="px-4 mt-1 mb-2">
        <Link
          href="#"
          className="text-[#2196F3] text-[15px] font-medium"
