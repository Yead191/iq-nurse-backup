        ...
        <div>
            <div className="container mx-auto">
                            ...
                            <div key={index} className=" border border-gray-200 rounded-xl  p-3">
                                <div className=" flex items-center gap-4">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <label htmlFor="all-medical" className="text-gray-700 flex  items-center gap-1">
                                            <span>All Medical Surgical </span>  <span className=" border px-4 py-1 border-gray-200 ps-2"> {values?.total} </span>
                                        </label>
                                    </div>
                                </div>
                ...
                <div className="flex items-center justify-end mt-4" >
                    <Link href={"/profile/flash-cards/create-flash/start-scratch/flash-folder"} className=' h-[45px] lg:w-[200px] w-full rounded-lg bg-[#003877] text-white flex items-center justify-center gap-1 cursor-pointer'>
