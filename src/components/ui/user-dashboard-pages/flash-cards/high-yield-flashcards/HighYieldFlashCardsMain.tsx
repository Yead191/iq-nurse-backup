        ...
        {flashTabsData.map((tab) => (
          <div key={tab.id} className="cursor-pointer">
            <div
              ...
              className={` border rounded-lg p-2 py-4 md:p-4 shadow-sm transition-all duration-300 hover:shadow-md group cursor-pointer w-full  flex flex-row items-center justify-between  gap-2 md:gap-4 ${
                activeTab === tab.id
