...
const NurseChat = () => {
    ...
    const content = [
        ...
        <PreviousChatSession key="3" chatSessions={tabsData?.dosageCalculationSessions} />,
        <PreviousChatSession key="4" chatSessions={tabsData?.reviewEssaySessions} />,
        <PreviousChatSession key="5" chatSessions={tabsData?.uploadDocumentSessions} />,
            ...
            <div className="flex-1 overflow-y-auto container mx-auto lg:p-8 p-2">
                <div className="text-center mb-8">
                    <div className='flex items-center justify-center lg:pb-8 pb-4'>
                        <img src="/assets/user-dashboard-images/nurse-q/chatAi.svg" alt="" className='lg:w-[130px] lg:h-[130px] w-[88px] h-[88px] ' />
                    </div>
                    <h1 className="lg:text-[23px] text-[19px] font-extrabold">Hi, I’m Nurse Q</h1>
                ...
                <div className="tabs flex flex-wrap w-full items-center justify-center lg:gap-4 gap-2 mb-4">
                    {tabs.map((tab, index) => (
                        <div
                            key={index}
                            className={`lg:px-4 px-1 py-2 rounded-full cursor-pointer flex items-center gap-1 bg-[#F8FAFC] text-[#475569] ${
                                activeTab === index
                        ...
                        >
                            <img src={tab?.iconImg} alt="" className="lg:w-5 lg:h-5 w-3 h-3 object-contain" />
                            <p className="lg:text-xs text-[7px] font-medium">{tab?.title}</p>
                        </div>
                    ))}
                </div>
