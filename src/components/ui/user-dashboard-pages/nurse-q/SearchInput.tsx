            ...
            <div className="border border-[#E2E8F0] p-4 rounded-xl flex flex-col gap-4">
                ...
                <div className="flex-1">
                    <div className=' flex items-center justify-end'>
                        ...
                        <button className=' h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center cursor-pointer ' onClick={()=>router.push("/profile/nurse-q/12")}> <IoIosSend size={24} color='#003877' /> </button>
                    </div>
                </div>
                ...
                <div className="flex flex-row  items-center  justify-between">
                    <div className=' flex flex-row  lg:gap-3 gap-1'>
                        <button className='text-[#02040F] h-9 w-9 cursor-pointer rounded-full bg-gray-100 flex items-center justify-center'> <HiOutlineLink size={20} /> </button>
                        ...
                        {isTyping && (
                            <button className="lg:px-4 px-2  lg:py-2 py-1 lg:text-sm text-[7px]  text-[#FF505B] bg-[#FEF2F2] border  border-[#FF505B] rounded-full cursor-pointer">
                                <span className=' font-medium '> Using 1 material(s) </span>   <span className=' text-[#1F7DDA]'> select Materials </span>
                            </button>
                        )}
                    </div>
