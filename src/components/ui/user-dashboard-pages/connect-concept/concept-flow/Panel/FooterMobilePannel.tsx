...
export const FooterMobilePannel = ({
  tabs,
  activeTabId,
  createTab,
  switchTab,
  ...
  return (
    <>
      <div className="flex flex-col justify-center  items-center gap-2 py-3 px-1 w-full pointer-events-none pb-14">
        ...
        <div
          className={`flex items-center justify-between pointer-events-auto bg-white rounded-xl shadow border ${
      ...
      >
        <div
          className={`  bottom-0 left-0 right-0 bg-white border-amber-400 !w-screen transition-transform duration-300 ease-in-out ${
