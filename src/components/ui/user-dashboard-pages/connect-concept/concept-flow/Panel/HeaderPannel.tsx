...
export const HeaderPanel = ({ collapsed }: { collapsed: boolean }) => {
    const date = new Date();
    ...
    return (
        <div
            className={`flex flex-col rounded-2xl bg-amber-300 transition-all duration-150 w-[100vw] ${!collapsed ? 'md:w-[calc(100vw-30.3125rem)]' : 'md:w-[calc(100vw-16.875rem)]'
                }`}
        >
