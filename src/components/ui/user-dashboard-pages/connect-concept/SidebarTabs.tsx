        ...
        <div className="w-full" style={{ minWidth: 0, overflow: "hidden" }}>
          <aside className="bg-white h-screen relative border-r border-gray-300">
            <div className="p-3 pt-5 border-b border-gray-200 flex items-center justify-between">
              ...
              <button
                onClick={createTab}
                className="flex items-center gap-1 text-xs px-2 py-1 rounded bg-[#2C5F8D] text-white"
                title="New Map"
  ...
  return (
    <div style={{ display: "flex", height: "100%" }}>
      ...
      >
        <aside
          className={`${
            collapsed ? "border border-white" : "border-r border-gray-300"
          } bg-white h-screen relative`}
        >
