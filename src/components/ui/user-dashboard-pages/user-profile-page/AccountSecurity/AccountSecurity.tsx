                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-x-10 gap-y-8">
                        ...
                        <div className="lg:col-span-9 col-span-12">
                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-5 gap-y-4">
                                <Form.Item
                                    name="firstName"
                                    label={<p className=" text-[#272728] font-medium ">First Name </p>}
                                    rules={[
                                ...
                                <Form.Item
                                    name="lastName"
                                    label={<p className=" text-[#272728] font-medium ">Last Name </p>}
                                    rules={[
                                ...
                                <Form.Item
                                    name="newPassword"
                                    label={<p className=" text-[#272728] font-medium ">New Password</p>}
                                    rules={[
                                ...
                                <Form.Item
                                    ...
                                    label={<p className=" text-[#272728] font-medium ">Confirm New Password </p>}
