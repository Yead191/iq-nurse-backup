    ...
    return (
        <div className="lg:px-6">
            ...
            <div className="mb-4 grid grid-cols-2 items-center justify-between  gap-4">
                ...
                <div className=" flex items-center gap-2  justify-center"> <span
                ...
                >
                    {knowCount}
                </span> <span>Review</span> </div>

                <div className=" flex items-center gap-2 justify-center"> <span
                    className={`w-8 h-8 flex items-center justify-center rounded ${getCardStyle("")}`}
                >
                    {stillLearningCount}
                </span> <span>Not attempted</span> </div> 

            </div> 


            <div className="flex lg:flex-row flex-col justify-between mt-5 gap-4">
                <button className="lg:w-[250px] w-full h-12 font-medium  rounded border border-[#484848] cursor-pointer" onClick={() => router?.push(`/profile/tests/high-yield-questions/${mode}/analyzing-results/review-exam`)}>Review exam</button>
                <button className="lg:w-[250px] w-full h-12 bg-[#003877] rounded border border-[#484848] text-white cursor-pointer" onClick={() => router?.push("/profile/tests/high-yield-questions")}>Exit Exam</button>
            </div>
            <p className="text-sm text-[#333333] mt-4">By clicking on exit your ans will be saved automatically</p>
        </div>
    );
}