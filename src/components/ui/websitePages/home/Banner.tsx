                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8 z-10">
                        <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight">
                            <span className="bg-gradient-to-r from-[#ffffff] via-[#63e5ff] to-[#33dfe5] bg-clip-text text-transparent pe-2">Master Your</span>
                            <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                                Nursing Journey
                            </span>{" "}
                            <span className="bg-gradient-to-r from-[#ffffff] via-[#63e5ff] to-[#33dfe5] bg-clip-text text-transparent"> with AI</span>
                        </h1>
