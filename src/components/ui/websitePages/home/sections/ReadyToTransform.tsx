      ...
      <div className="bg-[#051d3b] text-white py-24 px-4 text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-gray-400 text-lg md:text-xl leading-relaxed mb-10 max-w-3xl mx-auto">
            Join thousands of nursing students who are already succeeding with
            IQ-Nurse. Start your free trial today and experience the difference
            AI-powered learning can make.
          </p>
          <Link
            href="/auth/register"
