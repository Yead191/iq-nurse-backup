    ...
    return (
        <div className="h-full ">
            ...
            <div className="flex flex-col h-full lg:mt-0 mt-5 ">
                ...
                <div>
                    {
                        !showLabels ? <div className='flex items-center justify-between border-b border-[#E7E7E7] ps-[60px] pe-3 py-6 '>  
                        <div className=' flex items-center gap-1'> 
                         <img src="/favicon.svg" alt="Logo" className="lg:h-[32px] h-[32px] w-auto" />
                            <p className=' text-xl font-medium'> IQ-Nurse </p>
                             </div>
                            <button
