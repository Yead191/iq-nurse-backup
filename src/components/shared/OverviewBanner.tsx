...
export default function OverviewBanner({
  ...
  return (
    <section className="relative bg-gradient-to-br from-[#1B3E5F] via-[#122A44] to-[#0A1A2E] rounded-xl md:rounded-[24px] p-2 md:p-12 mb-10 overflow-visible h-[97px] md:h-[150px] lg:h-[200px] shadow-2xl flex ">
      ...
      <div className="flex flex-row items-center gap-8 relative z-10 lg:w-full">
        {/* Robot Image */}
        ...
        {/* Text Content */}
        <div className="flex-1 text-left -translate-x-12 lg:-translate-x-0">
          <h1 className="text-[16px] md:text-[28px] lg:text-[34px] font-bold text-white mb-2 md:mb-4 tracking-tight leading-none lg:leading-[37px]">
            {title || "Learn Smarter, Not Harder"}
          </h1>
          <p className="text-[#B0C4D6] text-[8px] leading-[12px] md:text-xl max-w-2xl lg:leading-[28px]">
            {description ||
        ...
        <div className="grid grid-cols-2 gap-2 lg:gap-3  self-end items-end lg:translate-y-7">
