...
export default function OverviewBanner({
  ...
  return (
    <section className="relative bg-gradient-to-br from-[#1B3E5F] via-[#122A44] to-[#0A1A2E] rounded-xl md:rounded-[24px] p-2 md:p-10 mb-10 overflow-visible h-[97px] md:h-[150px] lg:h-[200px] shadow-2xl flex items-center ">
      ...
      <div className="grid grid-cols-3 items-center gap-8 relative z-10 lg:w-full justify-between">
        ...
        <div className="absolute bottom-6 lg:bottom-16 right-3 lg:-right-4">
